    ...
    ((e) => {
      if (Array.isArray(e.begin)) {
        if (e.skip || e.excludeBegin || e.returnBegin)
          throw (F('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), P)
    ...
    ((e) => {
      if (Array.isArray(e.end)) {
        if (e.skip || e.excludeEnd || e.returnEnd)
          throw (F('skip, excludeEnd, returnEnd not compatible with endScope: {}'), P)
  ...
  return (
    ...
    (function t(r, s) {
      ...
      return (
        ...
        (l = l || /\w+/),
        r.keywords && (r.keywords = B(r.keywords, e.case_insensitive)),
  ...
  function y(e) {
    ...
    const t = ((e) => {
      ...
      if (t) {
        ...
        return (
          n ||
            (U(o.replace('{}', t[1])), U('Falling back to no-highlight mode for this block.', e)),
          n ? t[1] : 'no-highlight'
        )
      }
    ...
    if (
      ...
      throw new G('One of your code blocks includes unescaped HTML.', e.innerHTML)
    n = e
    ...
    Object.assign(n, {
      ...
      registerLanguage: (e, t) => {
        ...
        try {
          ...
          if ((F("Language definition for '{}' could not be registered.".replace('{}', e)), !s))
            throw n
          F(n), (i = l)
        }
        i.name || (i.name = e),
...
function he(e) {
  ...
  const m = [].concat(u, l.contains),
    ...
    y = {
      match: n.concat(
        /\b/,
        ((w = [...me, 'super', 'import']), n.concat('(?!', w.join('|'), ')')),
        t,
        n.lookahead(/\(/),
      ),
