...
const IDENT_RE = '[a-zA-Z]\\w*',
  ...
  COMMENT = function (e, n, t) {
    var r = inherit({ className: 'comment', begin: e, end: n, contains: [] }, t || {})
    return (
...
function compileLanguage(e) {
  ...
  !(function t(i, s) {
    i.compiled ||
      ...
      s &&
        (i.beginKeywords &&
          ((i.begin = '\\b(' + i.beginKeywords.split(' ').join('|') + ')(?=\\b|\\s)'),
          (i.__onBegin = a)),
        i.begin || (i.begin = /\B|\b/),
        (i.beginRe = n(i.begin)),
    ...
    function d(e, n, r, a) {
          ...
          : (function () {
              ...
              if (b.keywords) {
                for (n = 0, b.lexemesRe.lastIndex = 0, t = b.lexemesRe.exec(S), r = ''; t; ) {
                  ...
                  var a = null
                  ;(e = c(b, t))
                    ? (N.addText(r), (r = ''), (T += e[1]), (a = e[0]), N.addKeyword(t[0], a))
                    : (r += t[0]),
      ...
      function f(e) {
        ...
        return (
          ...
          t.skip
            ? (S += n)
            : (t.excludeBegin && (S += n), u(), t.returnBegin || t.excludeBegin || (S = n)),
          h(t),
      ...
      function E(e) {
        ...
        if (r) {
          ...
          a.skip
            ? (S += n)
            : (a.returnEnd || a.excludeEnd || (S += n), u(), a.excludeEnd && (S = n))
          do {
      ...
      function m(n, t) {
        ...
        if ('begin' == _.type && 'end' == t.type && _.index == t.index && '' === o) {
          if (((S += s.slice(t.index, t.index + 1)), !i))
            throw (
              (((a = new Error('0 width match regex')).languageName = e), (a.badRule = _.rule), a)
            )
          return 1
        }
        ...
        if ('illegal' === t.type && !r)
          throw (
            (((a = new Error(
              'Illegal lexeme "' + o + '" for mode "' + (b.className || '<unnamed>') + '"',
            )).mode = b),
            a)
          )
        if ('end' === t.type) {
      ...
      var n,
        ...
        d = (function (e) {
          var n,
            t = e.className + ' '
          if (
            ((t += e.parentNode ? e.parentNode.className : ''), (n = l.languageDetectRe.exec(t)))
          ) {
            var r = p(n[1])
            return (
              r ||
      ...
      c(d) ||
        ...
        (e.className = (function (e, n, t) {
          var a = n ? r[n] : t,
            i = [e.trim()]
          return (
            e.match(/\bhljs\b/) || i.push('hljs'), e.includes(a) || i.push(a), i.join(' ').trim()
          )
    ...
    Object.assign(e, {
      ...
      registerLanguage: function (n, a) {
        ...
        try {
          ...
          if (
            (console.error(
              "Language definition for '{}' could not be registered.".replace('{}', n),
            ),
            !i)
          )
            throw e
