  ...
  return (function () {
  ...
  })()(
    {
          ...
          a.exports = function (a) {
            ...
            a.enabled.length &&
              (o = Object.keys(o).reduce(function (e, n) {
                return a.enabled.indexOf(n) >= 0 && (e[n] = o[n]), e
              }, {})),
              (n = Object.keys(a.shortcuts).reduce(function (e, n) {
                return o[n]
                  ? Array.isArray(a.shortcuts[n])
                    ? (a.shortcuts[n].forEach(function (a) {
                        e[a] = n
                      }),
                      e)
                    : ((e[a.shortcuts[n]] = n), e)
      ...
      6: [
        function (require, a, exports) {
          'use strict'
          var e = require('./lib/data/full.json'),
            n = require('./lib/data/shortcuts'),
            o = require('./lib/render'),
            i = require('./lib/replace'),
            r = require('./lib/normalize_opts')
          a.exports = function (a, _) {
            var t = { defs: e, shortcuts: n, enabled: [] },
              s = r(a.utils.assign({}, t, _ || {}))
            ;(a.renderer.rules.emoji = o),
              a.core.ruler.push('emoji', i(a, s.defs, s.shortcuts, s.scanRE, s.replaceRE))
          }
        },
        {
