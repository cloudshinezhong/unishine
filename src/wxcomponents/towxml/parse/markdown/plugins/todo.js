        ...
        function (require, module, exports) {
            ...
            md.core.ruler.after('inline', 'github-task-lists', function (state) {
              ...
              let tagPaired = (index) => {
                let targetItem,
                  ...
                  level = item.level,
                  targetType =
                    item.type === 'list_item_open' ? 'list_item_close' : 'bullet_list_close'
          ...
          function makeCheckbox(token, TokenConstructor) {
            ...
            if (token.content.indexOf('[ ] ') === 0) {
              checkbox.content =
                '<checkbox class="h2w__todoCheckbox task-list-item-checkbox"' +
                disabledAttr +
                value +
                '/>'
            } else if (token.content.indexOf('[x] ') === 0 || token.content.indexOf('[X] ') === 0) {
              checkbox.content =
                '<checkbox class="h2w__todoCheckbox task-list-item-checkbox" checked="true"' +
                disabledAttr +
                value +
                '/>'
            }
